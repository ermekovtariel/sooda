...
function removeHtmlExceptBr(inputDiv) {
  var temp = inputDiv.innerHTML.replace(/<br\s*\/?>/gi, "[BR]");
  var stripped = temp.replace(/<[^>]+>/g, "");
  var _final = stripped.replace(/\[BR\]/gi, "</br>");
  return _final;
}
...
function useExpose(_ref) {
  var ref = _ref.ref, textInputRef = _ref.textInputRef, setValue = _ref.setValue, emitChange = _ref.emitChange;
  var _useSanitize = useSanitize(false), sanitize = _useSanitize.sanitize, sanitizedTextRef = _useSanitize.sanitizedTextRef;
...
function $fb96b826c0c5f37a$var$L(l16, u15, i10, t10, r10, o7, f6, c2) {
  ...
  if (null === d1)
    ...
    if ($fb96b826c0c5f37a$var$C(l16, p3, y2, r10, c2), v3)
      u15.__k = [];
    else if (_2 = u15.props.children, $fb96b826c0c5f37a$var$w(l16, Array.isArray(_2) ? _2 : [_2], u15, i10, t10, r10 && "foreignObject" !== d1, o7, f6, o7 ? o7[0] : i10.__k && $fb96b826c0c5f37a$var$k(i10, 0), c2), null != o7)
      for (_2 = o7.length; _2--; )
...
var $ec8c39fdad15601a$export$2e2bcd8739ae039 = class extends $dc040a17866866fa$export$221d75b3f55bb0bd {
  renderIcon(category) {
    ...
    if (icon) {
      ...
      if (icon.src)
        return $bd9dd35321b03dd4$export$34b9dba7ce09269b("img", {
          src: icon.src
        });
    }
...
function EmojiPicker(props) {
  ...
  var i18n = (0, import_react.useMemo)(function() {
    if (!language) {
      return void 0;
    }
    return __require("@emoji-mart/data/i18n/".concat(language !== null && language !== void 0 ? language : "en", ".json"));
  }, [language]);
...
function InputEmoji(props, ref) {
  ...
  var _useSanitize = useSanitize(props.shouldReturn), addSanitizeFn = _useSanitize.addSanitizeFn, sanitize = _useSanitize.sanitize, sanitizedTextRef = _useSanitize.sanitizedTextRef;
